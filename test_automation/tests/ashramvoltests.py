...
# def test_av_usrdtl_silence_3day(page, scenario_name):

#     scenario = data["test_av_usrdtl_silence_3day"]
#     user_dtls_page = UserDetailsPage(page)
#     find_user_page = FindUserPage(page)
...
#     result = user_dtls_page.get_reqid('test_av_usrdtl_silence_3day')
#     print(f"Scenario: {scenario}")
#     print(f"Result is: {result}")
#     assert result is not None
