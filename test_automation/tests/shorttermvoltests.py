...
# def test_stv_usrdtl_pgmvol_samyama(page, scenario_name):

#     scenario = data["test_stv_usrdtl_pgmvol_samyama"]
#     user_dtls_page = UserDetailsPage(page)
#     find_user_page = FindUserPage(page)
...
#     result = user_dtls_page.get_reqid('test_stv_usrdtl_pgmvol_samyama')
#     print(f"Scenario: {scenario}")
#     print(f"Result is: {result}")
#     assert result is not None
